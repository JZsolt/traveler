    ...
    days: [
      {
        ...
        schedule: [
          ...
          { time: "06:45", title: "🚌 FLIBCO busz → Brüsszel Midi", desc: "A FLIBCO shuttle közvetlenül a terminálból indul, félóránként. Jegyet előre érdemes venni.", highlight: true, links: [{ label: "flibco.com", url: "https://www.flibco.com" }], transport: [{ type: "transit", label: "🚌 FLIBCO busz · ~50 perc → Brussels-Midi", url: "https://www.google.com/maps/dir/Brussels+South+Charleroi+Airport/Brussels-Midi+Station" }] },
          { time: "07:45", title: "Érkezés Brussels-Midi → Metro a szálláshoz", transport: [{ type: "transit", label: "🚇 Metro M2/M6 · ~10 perc → Trône", url: "https://www.google.com/maps/dir/Brussels-Midi+Station/Trône+metro+station+Brussels" }] },
          { time: "08:15", title: "🏠 Szállás — poggyász lerakás", desc: "Rue De Pascale 15 — az EU-negyed szívében. Lehet, hogy korai a check-in, de a cuccot leadhatjátok.", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Rue+De+Pascale+15+Brussels+1040" }] },
