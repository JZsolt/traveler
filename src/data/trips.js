export const trips = [
  {
    ...
    usefulLinks: [
      ...
      { emoji: "🚂", name: "SNCB / Belgian Train", desc: "Belga vonatok — Bruges, Gent", url: "https://www.belgiantrain.be" },
      { emoji: "✈️", name: "FLIBCO", desc: "Charleroi reptér ↔ Brüsszel busz", url: "https://www.flibco.com" },
      { emoji: "🚇", name: "STIB-MIVB", desc: "Brüsszeli metró, villamos, busz", url: "https://www.stib-mivb.be" },
      { emoji: "🇳🇱", name: "NS International", desc: "Holland vonatok, nemzetközi jegyek", url: "https://www.nsinternational.com" }
    ],
    packingList: [
    ...
    days: [
      {
        ...
        images: [
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Bruxelles_Grand_Place.JPG/480px-Bruxelles_Grand_Place.JPG", caption: "Grand-Place — Brüsszel szíve" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Atomium_Br%C3%BCssel.JPG/480px-Atomium_Br%C3%BCssel.JPG", caption: "Atomium" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Manneken_Pis_Brussel.jpg/480px-Manneken_Pis_Brussel.jpg", caption: "Manneken Pis" }
        ],
        schedule: [
          ...
          { time: "09:30", title: "🌳 Parc du Cinquantenaire", badges: ["INGYENES"], desc: "Hatalmas park impozáns diadalívvel — I. Lipót belga király építtette Belgium 50. évfordulójára. A kislány futhat a réten, ti kávéztok a padon. Az ívek alatt néha kiállítások vannak.", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Parc+du+Cinquantenaire+Brussels" }], transport: [{ type: "walk", label: "🚶 ~5 perc · séta a szállástól", url: "https://www.google.com/maps/dir/Rue+De+Pascale+15+Brussels/Parc+du+Cinquantenaire" }], guide: {
              history: [
          ...
          { time: "10:30", title: "🇪🇺 Parlamentárium", badges: ["INGYENES", "GYEREKBARÁT"], desc: "Az Európai Parlament interaktív látogatóközpontja — 24 nyelven elérhető (magyarul is!). Multimédiás időutazás az EU történetén. A gyerekeknek külön interaktív állomások vannak. Nem tipikus múzeum, inkább élmény!", links: [{ label: "📍 Info", url: "https://visiting.europarl.europa.eu/en/visitor-offer/places-to-visit/parlamentarium" }], transport: [{ type: "walk", label: "🚶 ~10 perc · séta a parktól", url: "https://www.google.com/maps/dir/Parc+du+Cinquantenaire/Parlamentarium+Brussels" }], guide: {
              history: [
          ...
          { time: "12:15", title: "🍽 Ebéd — Moules-frites!", highlight: true, desc: "A belga nemzeti étel: gőzölt kagyló fehérboros szószban, sült krumplival! Chez Léon (1893 óta működik!) vagy bármelyik étterem a Rue des Bouchers-on. Tipp: a mellékutcák olcsóbbak. (~€12-18/fő)", links: [{ label: "📍 Étterem utca", url: "https://maps.google.com/?q=Rue+des+Bouchers+Brussels" }], transport: [{ type: "walk", label: "🚶 ~3 perc · vissza a Grand-Place felé", url: "https://www.google.com/maps/dir/Manneken+Pis/Rue+des+Bouchers+Brussels" }] },
          { time: "13:30", title: "🧇 Belga gofri kóstolás", desc: "Két típus létezik: a brüsszeli (könnyű, ropogós, téglalap alakú) és a liège-i (nehezebb, cukros, kerek). A Maison Dandoy 1829 óta süti a legjobbat! Utcai standokról ~€4-6/db, tejszínhabbal, eperrel, csokival.", links: [{ label: "📍 Maison Dandoy", url: "https://maps.google.com/?q=Maison+Dandoy+Grand+Place+Brussels" }], transport: [{ type: "walk", label: "🚶 ~1 perc · a Grand-Place sarkán", url: "https://www.google.com/maps/dir/Rue+des+Bouchers+Brussels/Maison+Dandoy+Grand+Place" }] },
          { time: "14:00", title: "🍫 Sablon negyed — csokoládé & antik", badges: ["INGYENES"], desc: "Brüsszel legelegánsabb negyede. Pierre Marcolini, Wittamer és Neuhaus (aki feltalálta a praliné bonbont 1912-ben!) mind itt van. Sok helyen ingyen kóstolhattok. Az antik boltok és galériák is lenyűgözőek. Hétvégenként antikpiac a téren.", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Place+du+Grand+Sablon+Brussels" }], transport: [{ type: "walk", label: "🚶 ~12 perc · séta délre, lejtőn le a Sablon felé", url: "https://www.google.com/maps/dir/Grand+Place+Brussels/Place+du+Grand+Sablon+Brussels" }], guide: {
              history: [
      ...
      },
      {
        ...
        images: [
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Keukenhof_Tulip_Gardens_1.JPG/480px-Keukenhof_Tulip_Gardens_1.JPG", caption: "Keukenhof — 7 millió tulipán" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg/480px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg", caption: "Van Gogh — Csillagos éj" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Amsterdam_canals_in_summer.JPG/480px-Amsterdam_canals_in_summer.JPG", caption: "Amszterdam csatornái" }
        ],
        alerts: [
        ...
        schedule: [
          ...
          { time: "~09:00", title: "📍 Érkezés Amsterdam Centraal", desc: "A pályaudvar maga is látnivaló — gyönyörű neoreneszánsz épület 1889-ből, a vízre épült cölöpökön! Csomagokat a locker-be (~€6-10).", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Amsterdam+Centraal" }] },
          ...
          { time: "13:45", title: "🍽 Ebéd: Albert Cuyp Piac", highlight: true, desc: "Amszterdam legnagyobb utcai piaca, 1905 óta! 300+ stand: holland sajt (próbáljátok a trüffelsajtosat!), friss hering, stroopwafel (frissen sütve, meleg karamellel), kibbeling (rántott hal). Budget paradicsom! (~€8-12/fő)", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Albert+Cuyp+Market+Amsterdam" }], transport: [{ type: "walk", label: "🚶 ~10 perc · séta a piactól", url: "https://www.google.com/maps/dir/Europaplein+Amsterdam/Albert+Cuyp+Market+Amsterdam" }], guide: {
              mustSee: [
      ...
      },
      {
        ...
        images: [
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Brugge-CanalRozenhoedkaai.JPG/480px-Brugge-CanalRozenhoedkaai.JPG", caption: "Rozenhoedkaai — a legikonikusabb pont" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Bruges_Market_Square_and_Belfry.jpg/480px-Bruges_Market_Square_and_Belfry.jpg", caption: "Markt tér és Belfort-torony" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/Brugge_beguinage.JPG/480px-Brugge_beguinage.JPG", caption: "Begijnhof — fehér házak, nyugalom" }
        ],
        alerts: [
        ...
        schedule: [
          ...
          { time: "10:45", title: "🏛 Markt (Piactér)", badges: ["INGYENES"], desc: "Bruges középkori szíve! A teret színes lépcsős oromzatú házak szegélyezik, középen Jan Breydel és Pieter de Coninck szobra (flamand szabadsághősök 1302-ből). A lovaskocsi-túrák is innen indulnak.", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Markt+Bruges" }], guide: {
              history: [
          ...
          { time: "12:00", title: "🚤 Csónaktúra a csatornákon", highlight: true, badges: ["GYEREKBARÁT"], desc: "~30 perces csónakázás Bruges titkos oldalát mutatja meg — alacsonyan ívelt hidak, lógó füzfák, hátsó kertek amiket az utcáról nem látnátok. Több indulási pont van, a legközelebbi a Burg-nál. ~€12/felnőtt, €7/gyerek.", transport: [{ type: "walk", label: "🚶 ~3 perc · több kikötő a Burg közelében", url: "https://www.google.com/maps/dir/Burg+Square+Bruges/Boat+tours+Bruges" }], guide: {
              mustSee: [
          ...
          { time: "12:45", title: "🍟 Ebéd — Bruges-i frietjes!", desc: "A belga sült krumpli az igazi \"French fries\" — kétszer sütve, kívül ropogós, belül puha! Rengeteg szósz közül választhattok (andalouse, samourai, tartare...). Stoofvlees (flamand sörben párolt marhapörkölt) a tökéletes mellé. (~€10-15/fő)", transport: [{ type: "walk", label: "🚶 ~5 perc · vissza a Markt felé", url: "https://www.google.com/maps/dir/Boat+tours+Bruges/Markt+Bruges" }] },
          { time: "13:30", title: "🍫 Csokoládé-séta", desc: "Bruges a belga csokoládé fővárosa — 50+ csokoládébolt a centrumban! Dumon: családi manufaktúra, mennyei trüffelek. The Chocolate Line: Dominique Persoone, a \"csokirocksztár\" boltja, meglepő ízek (wasabi, bacon...). Leonidas: a klasszikus, jó ár-érték arány ajándéknak. Sok helyen ingyen kóstolhattok!", transport: [{ type: "walk", label: "🚶 séta · boltról boltra a Katelijnestraat mentén", url: "https://www.google.com/maps/dir/Markt+Bruges/The+Chocolate+Line+Bruges" }] },
          { time: "14:30", title: "🏡 Begijnhof (Béguinage)", badges: ["INGYENES"], desc: "UNESCO Világörökség! Fehérre meszelt házacskák egy zárt udvar körül — a 13. században beginák (vallásos nők) éltek itt. Ma bencés apácáké. A kert tavasszal nárciszokkal tele — áprilisban tökéletes! Bruges legcsendesebb, legbékésebb helye.", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Begijnhof+Bruges" }], transport: [{ type: "walk", label: "🚶 ~10 perc · séta délre", url: "https://www.google.com/maps/dir/The+Chocolate+Line+Bruges/Begijnhof+Bruges" }], guide: {
              history: [
      ...
      },
      {
        ...
        images: [
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Grasbrug_en_Graslei.JPG/480px-Grasbrug_en_Graslei.JPG", caption: "Graslei — Gent szíve" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Gravensteen_Gent_vanuit_MIAT.JPG/480px-Gravensteen_Gent_vanuit_MIAT.JPG", caption: "Gravensteen — Grófok Vára" },
          { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Belgio_-_Gand_-_ponte_San_Michele%2C_chiesa_San_Michele_e_fiume_Lys.jpg/480px-Belgio_-_Gand_-_ponte_San_Michele%2C_chiesa_San_Michele_e_fiume_Lys.jpg", caption: "Sint-Michielsbrug — 3 torony" }
        ],
        alerts: [
        ...
        schedule: [
          ...
          { time: "15:30", title: "🍺 Terász a Graslei-n", desc: "Genti Gruut sör (egyedi: fűszerekkel készül, komló nélkül — visszanyúl a középkori sörhagyományhoz). A Graslei teraszán ülni a legszebb hely Gentben, különösen ha süt a nap. (~€4-6/fő)" },
          { time: "16:00", title: "🎨 Graffiti Street (Werregarenstraat)", badges: ["INGYENES", "GYEREKBARÁT"], desc: "Gent egyetlen legális graffiti utcája! Minden fal, ajtó és ablak tele van színes street art-tal — hetente változik. A kislány imádni fogja a színeket! Kb. 100 méter hosszú, de minden négyzetcenti tele van.", links: [{ label: "📍 Térkép", url: "https://maps.google.com/?q=Werregarenstraat+Gent" }], transport: [{ type: "walk", label: "🚶 ~3 perc · a Graslei-tól", url: "https://www.google.com/maps/dir/Graslei+Gent/Werregarenstraat+Gent" }], guide: {
              history: [
        ...
        costs: [
          { item: "Vonat Brüsszel↔Gent HÉTVÉGI jegy (4 felnőtt, gyerek ingyenes)", cost: "~€70" },
      ...
      },
      {
        ...
        schedule: [
          ...
          { time: "06:00", title: "🚌 FLIBCO → CRL", highlight: true, links: [{ label: "flibco.com", url: "https://www.flibco.com" }], transport: [{ type: "transit", label: "🚌 FLIBCO busz · ~50 perc → CRL", url: "https://www.google.com/maps/dir/Rue+De+Pascale+15+Brussels/Brussels+South+Charleroi+Airport" }] },
