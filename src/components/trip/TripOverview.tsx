...
import type { TripOverviewProps, UrgentBookingsProps } from '@/types/components'

function UrgentBookings({ bookings }: UrgentBookingsProps) {
...
export function TripOverview({ trip, slug, refetch }: TripOverviewProps) {
  return (
