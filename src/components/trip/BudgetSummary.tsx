...
import type { BudgetDraft, BudgetEditorProps, BudgetField, BudgetSummaryProps } from '@/types/components'
...
function BudgetEditor({ draft, onChange }: BudgetEditorProps) {
  function set(field: keyof BudgetDraft, value: string) {
