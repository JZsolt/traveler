    ...
    >
      <div className="bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white text-center py-16 px-6 md:py-24">
        ...
        <p className="text-base opacity-80 font-light">
          Minden kirándulás, egy helyen, linkekkel, menetrenddel, mindennel.
        </p>
      </div>
          ...
          {sorted.map((trip) => {
            ...
            return (
              ...
              >
                ...
                <div className="p-4">
                  <p className="text-sm font-semibold text-[#0f3460] mb-1">
                    {trip.subtitle}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {trip.highlights.map((h) => (
                      <span
                        key={h}
                        className="bg-slate-100 text-[#0f3460] text-[11px] font-medium px-2.5 py-0.5 rounded-full"
                      >
                        {h}
                      </span>
                    ))}
