...
- For code or task reviews in this repository, apply the standing architecture rules from `CLAUDE.md`, `tasks/PROJECT_RULES.md`, and `docs/architecture/ARCHITECTURE.md`.
