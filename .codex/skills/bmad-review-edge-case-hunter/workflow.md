...
- For code reviews in this repository, include architecture boundary risks from `AGENTS.md`, `tasks/PROJECT_RULES.md`, and `docs/architecture/ARCHITECTURE.md` when they create reachable edge cases.
